...
| `dispersion` | objet \| `null` | `effectif`, `iqr`, `etendue_min`, `etendue_max`, `ecart_type_reechantillonnage` |
| `observation` | objet | `debut`, `fin`, dates, **bornes incluses** — la période que la mesure décrit |
| `date_source` | date | date de publication ou `last-modified` de la source |
...
| `entrees` | tableau | ≥ 1 : `{source, url, empreinte_sha256, recupere_le}` |
...
ligne est une ligne. Empreintes réelles (`c5e405f1…` Scrutins L17,
`bbecd012…` AMO30, `1c1ec053…` CHES 2024, `bcc062b9…` nuances 2024,
`991c389d…` `data/registre/partis.exemple.json`).

```json
{"schema":"contrepoint/preuve/1","id":"5301775bd3d0722391ca09db93a462e933a42cdb9807848ebf0665033d2aab02","contrat":"0.1.0","famille":"votes","entite":"groupe.an17.lfi-nfp","valeur":-1.0000,"valeur_code":null,"echelle":{"id":"votes_lfi_rn","min":-1.0000,"max":1.0000,"decimales":4,"libelle":"Votes XVIIe législature, unités médianes LFI-NFP à RN"},"motif_code":null,"motif":null,"dispersion":{"effectif":73,"iqr":0.0470,"etendue_min":-1.1270,"etendue_max":0.0770,"ecart_type_reechantillonnage":0.0000},"observation":{"debut":"2024-10-08","fin":"2026-07-21"},"date_source":"2026-08-27","date_calcul":"2026-08-27T00:00:00Z","methode":{"id":"votes_rang1_ancre","version":"1.0.0","parametres":{"ancre_droite":"groupe.an17.rn","ancre_gauche":"groupe.an17.lfi-nfp","codage":"pour=+1;contre=-1;abstention=0;non_votant=manquant;absent=manquant","filtre_scrutins":"minorite_non_vide","iterations_als":300,"scrutins_ecartes":455,"scrutins_retenus":7979}},"epingles":[],"entrees":[{"source":"an_scrutins_17","url":"https://data.assemblee-nationale.fr/static/openData/repository/17/loi/scrutins/Scrutins.json.zip","empreinte_sha256":"c5e405f1a715086b9325a585db80362e8e7e03b9d4178ea4e35b9009bdfcf59f","recupere_le":"2026-08-27"},{"source":"an_organe","url":"https://data.assemblee-nationale.fr/static/openData/repository/17/amo/tous_acteurs_mandats_organes_xi_legislature/AMO30_tous_acteurs_tous_mandats_tous_organes_historique.json.zip","empreinte_sha256":"bbecd01274d2bc9f46fcaa276b06868862ae7680131da3162e35b5cbef663061","recupere_le":"2026-08-27"},{"source":"registre_partis","url":"https://raw.githubusercontent.com/bourbask/contrepoint/v0.1.0/data/registre/partis.json","empreinte_sha256":"991c389d34573dc2dbeebd022145b9b85030fc5ace1576e536891d5c8ce19308","recupere_le":"2026-08-27"}],"logiciel":{"version":"0.1.0","commit":null}}
```

```json
{"schema":"contrepoint/preuve/1","id":"4bac94c165ab6563e057dec7c0e265ed0a92d4e5a54bc244cffb0c651c4e6021","contrat":"0.1.0","famille":"votes","entite":"groupe.an17.rn","valeur":1.0000,"valeur_code":null,"echelle":{"id":"votes_lfi_rn","min":-1.0000,"max":1.0000,"decimales":4,"libelle":"Votes XVIIe législature, unités médianes LFI-NFP à RN"},"motif_code":null,"motif":null,"dispersion":{"effectif":129,"iqr":0.0520,"etendue_min":0.8140,"etendue_max":1.1390,"ecart_type_reechantillonnage":0.0000},"observation":{"debut":"2024-10-08","fin":"2026-07-21"},"date_source":"2026-08-27","date_calcul":"2026-08-27T00:00:00Z","methode":{"id":"votes_rang1_ancre","version":"1.0.0","parametres":{"ancre_droite":"groupe.an17.rn","ancre_gauche":"groupe.an17.lfi-nfp","codage":"pour=+1;contre=-1;abstention=0;non_votant=manquant;absent=manquant","filtre_scrutins":"minorite_non_vide","iterations_als":300,"scrutins_ecartes":455,"scrutins_retenus":7979}},"epingles":[],"entrees":[{"source":"an_scrutins_17","url":"https://data.assemblee-nationale.fr/static/openData/repository/17/loi/scrutins/Scrutins.json.zip","empreinte_sha256":"c5e405f1a715086b9325a585db80362e8e7e03b9d4178ea4e35b9009bdfcf59f","recupere_le":"2026-08-27"},{"source":"an_organe","url":"https://data.assemblee-nationale.fr/static/openData/repository/17/amo/tous_acteurs_mandats_organes_xi_legislature/AMO30_tous_acteurs_tous_mandats_tous_organes_historique.json.zip","empreinte_sha256":"bbecd01274d2bc9f46fcaa276b06868862ae7680131da3162e35b5cbef663061","recupere_le":"2026-08-27"},{"source":"registre_partis","url":"https://raw.githubusercontent.com/bourbask/contrepoint/v0.1.0/data/registre/partis.json","empreinte_sha256":"991c389d34573dc2dbeebd022145b9b85030fc5ace1576e536891d5c8ce19308","recupere_le":"2026-08-27"}],"logiciel":{"version":"0.1.0","commit":null}}
```

```json
{"schema":"contrepoint/preuve/1","id":"d269924ae9342f348223471be3b59d171356d04cf372e804c2c4626371abbf61","contrat":"0.1.0","famille":"votes","entite":"groupe.an17.liot","valeur":null,"valeur_code":null,"echelle":{"id":"votes_lfi_rn","min":-1.0000,"max":1.0000,"decimales":4,"libelle":"Votes XVIIe législature, unités médianes LFI-NFP à RN"},"motif_code":"sous_seuil_de_publication","motif":"Dispersion interne au-delà du seuil publié : IQR 0,687 pour un maximum de 0,25.","dispersion":{"effectif":25,"iqr":0.6870,"etendue_min":-0.5510,"etendue_max":0.4490,"ecart_type_reechantillonnage":0.0176},"observation":{"debut":"2024-10-08","fin":"2026-07-21"},"date_source":"2026-08-27","date_calcul":"2026-08-27T00:00:00Z","methode":{"id":"votes_rang1_ancre","version":"1.0.0","parametres":{"ancre_droite":"groupe.an17.rn","ancre_gauche":"groupe.an17.lfi-nfp","codage":"pour=+1;contre=-1;abstention=0;non_votant=manquant;absent=manquant","filtre_scrutins":"minorite_non_vide","iterations_als":300,"scrutins_ecartes":455,"scrutins_retenus":7979}},"epingles":[],"entrees":[{"source":"an_scrutins_17","url":"https://data.assemblee-nationale.fr/static/openData/repository/17/loi/scrutins/Scrutins.json.zip","empreinte_sha256":"c5e405f1a715086b9325a585db80362e8e7e03b9d4178ea4e35b9009bdfcf59f","recupere_le":"2026-08-27"},{"source":"an_organe","url":"https://data.assemblee-nationale.fr/static/openData/repository/17/amo/tous_acteurs_mandats_organes_xi_legislature/AMO30_tous_acteurs_tous_mandats_tous_organes_historique.json.zip","empreinte_sha256":"bbecd01274d2bc9f46fcaa276b06868862ae7680131da3162e35b5cbef663061","recupere_le":"2026-08-27"},{"source":"registre_partis","url":"https://raw.githubusercontent.com/bourbask/contrepoint/v0.1.0/data/registre/partis.json","empreinte_sha256":"991c389d34573dc2dbeebd022145b9b85030fc5ace1576e536891d5c8ce19308","recupere_le":"2026-08-27"}],"logiciel":{"version":"0.1.0","commit":null}}
```

```json
{"schema":"contrepoint/preuve/1","id":"ae4508151abc6386ee763aaf75aadb77c24010315a7810db689102cdff6cddb3","contrat":"0.1.0","famille":"experts","entite":"parti.rn","valeur":8.82,"valeur_code":null,"echelle":{"id":"ches_lrgen_0_10","min":0.00,"max":10.00,"decimales":2,"libelle":"CHES 2024, variable lrgen, échelle 0 à 10"},"motif_code":null,"motif":null,"dispersion":null,"observation":{"debut":"2024-01-01","fin":"2024-12-31"},"date_source":"2026-08-27","date_calcul":"2026-08-27T00:00:00Z","methode":{"id":"ches_lrgen","version":"1.0.0","parametres":{"colonne":"lrgen","pays":6,"vague":"2024"}},"epingles":[],"entrees":[{"source":"ches_2024","url":"https://github.com/chesdata/chesdata.github.io/releases/download/ches-europe/CHES_2024_final_v2.csv","empreinte_sha256":"1c1ec0532afa2a0a13317122cbbe40eb9ff35425191892d1fff24fbef6acc6a8","recupere_le":"2026-08-27"},{"source":"registre_partis","url":"https://raw.githubusercontent.com/bourbask/contrepoint/v0.1.0/data/registre/partis.json","empreinte_sha256":"991c389d34573dc2dbeebd022145b9b85030fc5ace1576e536891d5c8ce19308","recupere_le":"2026-08-27"}],"logiciel":{"version":"0.1.0","commit":null}}
```

```json
{"schema":"contrepoint/preuve/1","id":"1d824226ce54d92799e6649907e633772b78fdb7ce993cc2a468c1ff5dfed9b0","contrat":"0.1.0","famille":"administratif","entite":"coalition.nfp","valeur":null,"valeur_code":"UG","echelle":{"id":"nuance_leg2024","min":null,"max":null,"decimales":null,"libelle":"Code de nuance attribué à une candidature, législatives 2024"},"motif_code":null,"motif":null,"dispersion":null,"observation":{"debut":"2024-06-30","fin":"2024-07-07"},"date_source":"2024-07-10","date_calcul":"2026-08-27T00:00:00Z","methode":{"id":"nuance_constatee","version":"1.0.0","parametres":{"colonne":"Nuance candidat","reference_grille":"IOMA2415630C du 2024-06-11","tour":"2"}},"epingles":[],"entrees":[{"source":"nuance_leg2024","url":"https://static.data.gouv.fr/resources/elections-legislatives-des-30-juin-et-7-juillet-2024-resultats-definitifs-du-2nd-tour/20240710-170728/resultats-definitifs-par-circonscription.csv","empreinte_sha256":"bcc062b9264dcf3dc1eac5463acf1e8743171b86385923e7f770fd9028271083","recupere_le":"2026-08-27"},{"source":"registre_partis","url":"https://raw.githubusercontent.com/bourbask/contrepoint/v0.1.0/data/registre/partis.json","empreinte_sha256":"991c389d34573dc2dbeebd022145b9b85030fc5ace1576e536891d5c8ce19308","recupere_le":"2026-08-27"}],"logiciel":{"version":"0.1.0","commit":null}}
```
...
**Tailles mesurées.** 1 823, 1 817, 1 919, 1 148 et 1 321 octets, dont 805, 805,
805, 480 et 570 pour `entrees` — soit 44 % d'une ligne de la famille `votes`.
La v0 émet 35 lignes (32 marqueurs plus 3 absences documentées), soit de l'ordre
de 55 Ko à la moyenne de ces cinq lignes. Le coût est assumé : une ligne de preuve
...
catalogue commité indexé sur l'empreinte, et `entrees` retombe à
`{source, empreinte_sha256}` — mineure, sans effet sur `id` puisque seule
l'empreinte entre dans la clé.
...
cle = famille ␟ entite ␟ observation.debut ␟ observation.fin
      ...
      ␟ empreintes des entrees, triées par ordre lexicographique, jointes par ","
...
empreintes de toutes les entrées — dont celle du registre d'entités. Une
correction d'appariement dans le registre change son empreinte, donc l'`id`,
donc ré-émet les lignes concernées. C'est exactement ce que l'ADR 0000 §6 décrit
comme un patch qui ré-émet des preuves.
...
| `entrees[].url` | l'URL d'une source peut être redirigée sans que la donnée change ; l'empreinte, non |
...
printf '%s\x1f%s\x1f%s\x1f%s\x1f%s\x1f%s\x1f%s\x1f%s' \
  ...
  '991c389d34573dc2dbeebd022145b9b85030fc5ace1576e536891d5c8ce19308,bbecd01274d2bc9f46fcaa276b06868862ae7680131da3162e35b5cbef663061,c5e405f1a715086b9325a585db80362e8e7e03b9d4178ea4e35b9009bdfcf59f' \
  | sha256sum
# 4bac94c165ab6563e057dec7c0e265ed0a92d4e5a54bc244cffb0c651c4e6021
```
...
{"id":"parti.lfi","libelle":"La France insoumise","marqueurs":[
 {"famille":"votes","echelle":"votes_lfi_rn","valeur":-1.0000,"valeur_code":null,"libelle":"Votes du groupe LFI-NFP","motif_code":null,"motif":null,"dispersion":{"effectif":73,"iqr":0.0470},"preuve":"5301775bd3d0722391ca09db93a462e933a42cdb9807848ebf0665033d2aab02"},
...
{"id":"groupe.an17.liot","libelle":"LIOT","marqueurs":[
 {"famille":"votes","echelle":"votes_lfi_rn","valeur":null,"valeur_code":null,"libelle":"Votes du groupe LIOT","motif_code":"sous_seuil_de_publication","motif":"Dispersion interne au-delà du seuil publié : IQR 0,687 pour un maximum de 0,25.","dispersion":{"effectif":25,"iqr":0.6870},"preuve":"d269924ae9342f348223471be3b59d171356d04cf372e804c2c4626371abbf61"}]}
```
...
le front n'affiche jamais une preuve reformatée. En v0, un clic charge de 1,1 à
1,9 Ko. Les éclats ne contiennent que les lignes référencées par au moins un
...
- **I1** Toute ligne porte `entrees` non vide, chaque entrée avec `source` de la liste close, `empreinte_sha256` de 64 hexadécimaux et `recupere_le`. Aucune position sans source empreintée.
...
| Tableaux | `entrees` triée par `empreinte_sha256`, `epingles` par `nom`, `bandes` par valeur du marqueur `votes` puis par `id`, `marqueurs` dans l'ordre de `familles` du manifeste |
...
`entrees[].empreinte_sha256` porte l'empreinte.
...
| `date_source` de CHES : la date retenue est celle de récupération, faute de date de publication déclarée par la source | Chercher une date de publication sur la page de la version `ches-europe` |
