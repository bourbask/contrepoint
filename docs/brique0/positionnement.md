...
| 9 | Gain du rang 1 sur le résidu après cette constante | **59,2 %** pour une constante calculée **une fois** (60,9 % hors abstentions ; identique en codage 0/1). **60,8 % pour la constante réajustée à chaque itération**, conjointement au rang 1 — c'est ce modèle qui est implémenté, et l'écart de 1,6 point est de modèle et non de convergence, mesuré le 2026-08-28 en ajustant les deux côte à côte. Le **59,1 %** que ce tableau portait jusqu'au 2026-08-28 venait de l'exploration Python hors dépôt ; la mesure côte à côte de l'implémentation Rust donne **59,2 %** (verification-2026-08-27.md §3). Les 0,1 point d'écart entre les deux implémentations ne sont pas expliqués — `A VERIFIER` |
